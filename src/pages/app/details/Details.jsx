...
function Details() {
  ...
  const detailsData = coursesData.find((courses) => courses.id === courseId);
  return (
      ...
      <div className={style.card_container}>
        <div className={style.card_image}>
          <div className={style.image_container}>
            ...
            <img src={detailsData.img} alt="icons" />
          </div>
        </div>
        <div className={style.card_content}>
          {/*Third Task:  Title and Description here */}
          <h1 className={style.card_title}>{detailsData.title}</h1>
          <p className={style.card_description}>{detailsData.description}</p>
        </div>
      </div>
